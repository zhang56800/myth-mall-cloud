...
import com.myth.mall.cloud.dao.IndexConfigMapper;
...
@Service
public class MythMallIndexConfigServiceImpl implements MythMallIndexConfigService {

    @Autowired
    private IndexConfigMapper indexConfigMapper;

    @Autowired
    private MythCloudGoodsServiceFeign goodsService;
    ...
    public String saveIndexConfig(IndexConfig indexConfig) {
        Result<MythMallGoodsDTO> goodsDetailResult = goodsService.getGoodsDetail(indexConfig.getGoodsId());
